...
// Write a function that determines years to reach level 10
function calculateYearsToPromotion(employeeLevel) {
    if (employeeLevel >= 10) {
        return "Years to Level 10: 0";
    }
    else return `Years to Level 10: ${(10 - employeeLevel) * 2}`; // Each promotion takes 2 years
};
// Calculate years to Promotion
